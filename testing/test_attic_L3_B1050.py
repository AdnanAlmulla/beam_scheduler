...
def example_beam() -> SRC.beam.Beam:
    ...
    example_beam = SRC.beam.Beam(
        ...
        req_shear_flex_reinf=[0, 0, 0],  # left, middle, right
...
def test_get_flex_req(designed_beam: SRC.beam_design.BeamDesign) -> None:
    ...
    assert designed_beam.beam.req_top_flex_reinf == [1979, 703, 1979]

    assert designed_beam.beam.req_bot_flex_reinf == [1230, 1099, 1053]
